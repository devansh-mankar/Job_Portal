...
import CardWithLink from "./jobCard";
...
const filters = [
  {
    ...
    options: [
      ...
      { value: "Noida", label: "Noida", checked: true },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "human resource", label: "human resource", checked: true },
      { value: "consultancy", label: "consultancy", checked: false },
              ...
              <form className="mt-4  border-t border-gray-200">
                ...
                {filters.map((section) => (
                  <Disclosure
                    key={section.id}
                    as="div"
                    className="border-t font-bold border-gray-200 px-4 py-6"
                  >
        ...
        <main className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3 overflow-y-auto max-h-[calc(100vh-200px)] p-4">
                {/* Adjust the height as needed */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 space-x-4">
                  {allJobs.map((job) => (
                    <CardWithLink
                      job={job}
                      className=""
